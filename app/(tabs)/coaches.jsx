...
const coaches = [
  { nom: 'Karim B.', specialite: 'Musculation & Force', experience: '8 ans', tarif: '60/seance', dispo: true },
  { nom: 'Sofia M.', specialite: 'Cardio & Perte de poids', experience: '5 ans', tarif: '50/seance', dispo: true },
  { nom: 'Lucas D.', specialite: 'Nutrition & Performance', experience: '10 ans', tarif: '75/seance', dispo: false },
];
            ...
            <View style={styles.nameRow}>
              ...
              <View style={[styles.badge, { backgroundColor: c.dispo ? '#1a3a1a' : '#2a1a1a' }]}>
                <Text style={[styles.badgeText, { color: c.dispo ? '#4caf50' : '#E63946' }]}>
                  {c.dispo ? t.disponibleLabel : t.complet}
                </Text>
              </View>
            </View>
            <Text style={styles.specialite}>{c.specialite}</Text>
            <Text style={styles.meta}>{c.experience} • {c.tarif}</Text>
            {c.dispo && (
              <TouchableOpacity
                style={styles.btn}
