...
const SEMAINES = ['Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam', 'Dim'];
...
export default function Progression() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.sous}>Suivi de tes performances</Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.objectifCard}>
          <View style={styles.objectifHeader}>
            <Text style={styles.objectifLabel}>Calories brulees</Text>
        ...
        <View style={styles.objectifCard}>
          <View style={styles.objectifHeader}>
            <Text style={styles.objectifLabel}>Minutes actives</Text>
